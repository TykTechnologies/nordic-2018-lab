...
public final class DispatcherGrpc {
  ...
  private static final class DispatcherDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
      ...
      synchronized (DispatcherGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new DispatcherDescriptorSupplier())
              .addMethod(METHOD_DISPATCH)
              .addMethod(METHOD_DISPATCH_EVENT)
              .build();
        }
      }
    }
